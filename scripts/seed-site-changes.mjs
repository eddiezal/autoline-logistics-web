...
const ENTRIES = [
  ...
  ["2026-07-15", "analysis", "D", "Historical ads spend audited before relaunch",
    "Full autopsy of the account's all-time search data showed most past spend never reached real car-shipping searches. The finding shaped the entire relaunch structure: every campaign now maps to proven customer intent.", "/admin/analysis/search-terms-autopsy"],
  ["2026-07-24", "analysis", "-", "Pricing pattern discovered in the order book",
    "Analyzed 336 booked orders and found the consistent way deals actually close: carrier cost plus a predictable service fee. This became the blueprint for the website's live pricing model.", "/admin/analysis/flat-fee-discovery"],
  ["2026-07-29", "analysis", "D", "Ad budgets recalculated to serving days",
    "Daily budgets had been derived from calendar days, but ads run weekdays only. Recomputed against actual serving days and rebalanced campaigns; the account stopped throttling its best performers.", "/admin/analysis/serving-days-recalc"],
  ["2026-07-30", "analysis", "-", "Remote-route pricing premium quantified",
    "Routes far from major metro areas cost measurably more to cover, and now we know how much. Built from our own booked orders; feeds the next version of the pricing model so remote quotes stay accurate.", "/admin/analysis/remoteness-premium"],
  ["2026-08-04", "analysis", "D", "Bid cap experiment: cheaper research clicks, verdict in",
    "Two-week controlled test of a lower bid ceiling on the research campaign.", "/admin/analysis/bid-cap-experiment",
  ...
  ["2026-08-04", "analysis", "-", "Order book refreshed through August 4",
    "Monthly data pull analyzed and reconciled: 379 booked orders since March, $95.9K in broker fees on $560K gross moved. August opened at the fastest pace in the book's history.", "/admin/analysis/order-book"],
